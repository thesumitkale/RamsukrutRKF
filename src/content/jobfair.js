...
export const jobfair = {
  en: {
    ...
    meta: {
      ...
      description: 'A free one day job fair on 29 September 2026. Reporting at 9:00 AM, process runs till 5:00 PM, busy desks till 8:00 PM. Register as a candidate or book a hiring desk for your company.',
    },
    ...
    facts: [
      ...
      { k: 'Reporting time', v: '9:00 AM sharp, process runs till 5:00 PM, busy desks till 8:00 PM' },
    ...
    mine: {
      ...
      sub: 'Type the mobile number you registered with. You will see the companies coming on 29 September that best fit what you have studied and done, strongest first, and you can pick up to 3 to appear for.',
      ...
      fullBtn: 'Limit of 3 reached',
      dayTitle: 'Your day at the fair',
      dayShotTitle: 'Take a screenshot of this plan.',
      dayShotBody: 'Keep it on your phone and show it at the help desk and at every company desk. It works without internet.',
      dayDate: 'Tuesday, 29 September 2026',
      dayReport: 'Report at the gate by',
      dayGroup: 'Your group',
      dayStops: 'Where you go, in this order',
      dayTest: 'Aptitude test for Zeal Connect and Techspian',
      dayTestNote: 'One sitting for all IT candidates at 10:00, 45 minutes, in the test hall. One test counts for both companies. Shortlisted names are called by name to the Zeal and Techspian desks for interview from 11:30 to 8:00 PM, so stay at the venue.',
      ...
      reserveTitle: 'You are on the reserve list',
      reserveBody: 'Every desk that fits your profile is full for now. Come by 12:30 PM and go to the help desk. Volunteers will send you to the first desk that opens up.',
      fullErr: 'You have already picked 3 companies. Remove one to choose this one instead.',
  ...
  mr: {
    ...
    meta: {
      ...
      description: '२९ सप्टेंबर २०२६ रोजी मोफत रोजगार मेळावा. सकाळी ९:०० वाजता हजर राहा, प्रक्रिया सायंकाळी ५:०० पर्यंत चालेल, काही डेस्क रात्री ८:०० पर्यंत. उमेदवार म्हणून नोंदणी करा किंवा तुमच्या कंपनीसाठी भरती डेस्क बुक करा.',
    },
    ...
    facts: [
      ...
      { k: 'हजर राहण्याची वेळ', v: 'सकाळी ९:०० वाजता, प्रक्रिया सायंकाळी ५:०० पर्यंत, काही डेस्क रात्री ८:०० पर्यंत' },
    ...
    mine: {
      ...
      sub: 'तुम्ही ज्या मोबाइल क्रमांकावरून नोंदणी केली तो टाका. 29 सप्टेंबरला येणाऱ्यांपैकी तुमच्या शिक्षणाशी आणि अनुभवाशी सर्वात जास्त जुळणाऱ्या कंपन्या दिसतील, सर्वात जुळणारी आधी, आणि त्यापैकी जास्तीत जास्त 3 निवडता येतील.',
      ...
      fullBtn: '3 ची मर्यादा पूर्ण',
      dayTitle: 'मेळाव्यातील तुमचा दिवस',
      dayShotTitle: 'या प्लॅनचा स्क्रीनशॉट घ्या.',
      dayShotBody: 'तो फोनमध्ये ठेवा आणि मदत कक्षात व प्रत्येक कंपनीच्या टेबलवर दाखवा. इंटरनेटशिवायही चालतो.',
      dayDate: 'मंगळवार, 29 सप्टेंबर 2026',
      dayReport: 'प्रवेशद्वारावर या वेळेपर्यंत पोहोचा',
      dayGroup: 'तुमचा गट',
      dayStops: 'या क्रमाने जा',
      dayTest: 'झील कनेक्ट आणि टेक्स्पियनसाठी अभियोग्यता चाचणी',
      dayTestNote: 'सर्व आयटी उमेदवारांची एकच चाचणी सकाळी 10:00 वाजता, 45 मिनिटे, चाचणी हॉलमध्ये. एकच चाचणी दोन्ही कंपन्यांसाठी ग्राह्य. निवड झालेल्यांना सकाळी 11:30 ते रात्री 8:00 या वेळेत नावाने झील आणि टेक्स्पियन डेस्कवर मुलाखतीसाठी बोलावले जाईल, त्यामुळे ठिकाणीच थांबा.',
      dayDesk: 'मुलाखत टेबल',
      ...
      reserveTitle: 'तुमचे नाव राखीव यादीत आहे',
      reserveBody: 'तुमच्या प्रोफाइलला जुळणारी सर्व टेबल सध्या भरलेली आहेत. दुपारी 12:30 पर्यंत या आणि मदत कक्षात जा. जे टेबल आधी मोकळे होईल तिथे स्वयंसेवक तुम्हाला पाठवतील.',
      fullErr: 'तुम्ही आधीच 3 कंपन्या निवडल्या आहेत. ही निवडायची असेल तर आधी एक काढा.',
