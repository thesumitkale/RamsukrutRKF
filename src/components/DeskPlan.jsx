    ...
    <div className="mt-5 space-y-5">
      ...
      <div className="rounded-[8px] border border-sand bg-paper p-5 shadow-soft">
        ...
        <p className="mt-4 text-[0.85rem] leading-[1.6] text-muted">
          The floor opens at 10:00 and the last slot starts at 7:30, so the day ends at 8:00 for the busiest desks. Desks booked more than 10 a slot before 5:00 run till 8:00, the rest close at 5:00. Every desk opens at 10:00 and is booked at most {PER_PANEL} a slot, about 8 seen, since we expect about 800 of 1,368 to come. Desks with two panels share those {PER_PANEL}, so each panel sees about 4 every 30 minutes. The Zeal and Techspian aptitude test is one sitting for every IT candidate at 10:00. They then go to two related desks, spread over the rest of the day, while Zeal and Techspian interview their shortlist by name from 11:30 to 8:00. Everyone enters by 9:30 and is briefed at any of the 22 help desks, which look people up here by name or mobile. New people only fill spare room from the next wave onwards.
        </p>
      </div>
